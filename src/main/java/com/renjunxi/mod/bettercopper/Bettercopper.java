...
public class Bettercopper implements ModInitializer {
    ...
    public static final BucketItem COPPER_BUKKIT=new BucketItem(Fluids.EMPTY, new Item.Settings().group(ItemGroup.MISC));
    public static final BucketItem COPPER_WATER_BUKKIT=new BucketItem(Fluids.EMPTY, new Item.Settings().group(ItemGroup.MISC));
    @Override
